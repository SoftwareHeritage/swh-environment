...
Detailed per-MR scope, file lists, and test plans are in the companion plan at `notes/git-loader-rehaul/PLAN-rec-l4-execution.md` on the `audit/git-loader-rehaul` branch of swh-environment.
...
- Detailed per-MR execution plan: `notes/git-loader-rehaul/PLAN-rec-l4-execution.md`
...
- `execute_many_statements_with_retries` (REC-L4 stacks on this): [cql.py L489-L507](https://gitlab.softwareheritage.org/swh/devel/swh-storage/-/blob/master/swh/storage/cassandra/cql.py#L489-507)
...
**Prior art:**
- Nicolas Dandrimont's batched-read commits (Sept 2025): `9a4d5596`, `9da2c163`, `c5e77f48` — the prepared-statement scaffolding REC-L4 stacks on.
- Original REC-L4 branch (pre-rewrite): preserved at tag `rec-l4-v0-history` on swh-storage.
